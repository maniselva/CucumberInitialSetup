...
@CucumberOptions
		(
			...
			//tags = {"@ChangeGroup,@ChangeSet,@DataElement,@DataCategory,@DataFeed,@ExtractConfiguration,@ChangeManagementReleaseView,@EventMonitor,@DataSources,@DataMart,@ChangeGroupImport,@DataElementValueTrace,@DataMartVisualizer,@DataMartElement,@MetaModelOverView,@QuickSearch,@NavigationSearch"},
			tags = {"@saveform"},
			monochrome = true,
